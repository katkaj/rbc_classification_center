...
import libs
import libs_dataset
import models.model_lstm_64.src.model as Modellstm64
...
train = libs.Train(dataset, Modellstm64, batch_size = 256, learning_rates = learning_rates)
train.step_epochs(epoch_count, log_path = "../models/model_lstm_64")

'''
training result saved into ../models/model_lstm_64/result
...
best model is saved into ../models/model_lstm_64/trained
and results into ../models/model_lstm_64/result/best.log
'''
