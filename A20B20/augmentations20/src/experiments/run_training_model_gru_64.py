...
import libs
import libs_dataset
import models.model_gru_64.src.model as Modelgru_64
...
train = libs.Train(dataset, Modelgru_64, batch_size = 256, learning_rates = learning_rates)
train.step_epochs(epoch_count, log_path = "../models/model_gru_64")

'''
training result saved into ../models/model_gru_64/result
...
best model is saved into ../models/model_gru_64/trained
and results into ../models/model_gru_64/result/best.log
'''
