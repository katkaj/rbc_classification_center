...
import libs
import libs_dataset
import models.model_lstm_64_ws64.src.model as Modellstm_64_ws64
...
train = libs.Train(dataset, Modellstm_64_ws64, batch_size = 256, learning_rates = learning_rates)
...
and results into ../models/model_lstm_64_ws64/result/best.log
'''
