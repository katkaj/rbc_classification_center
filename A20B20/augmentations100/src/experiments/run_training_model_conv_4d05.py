...
import libs
import libs_dataset
import models.model_conv_4d05.src.model as Modelconv_4d05
...
train = libs.Train(dataset, Modelconv_4d05, batch_size = 256, learning_rates = learning_rates)
...
and results into ../models/model_conv_4d05/result/best.log
'''
