...
import libs
import libs_dataset
import models.model_lstm.src.model as Modellstm
...
train = libs.Train(dataset, Modellstm, batch_size = 256, learning_rates = learning_rates)
train.step_epochs(epoch_count, log_path = "../models/model_lstm")

'''
training result saved into ../models/model_lstm/result
...
best model is saved into ../models/model_lstm/trained
and results into ../models/model_lstm/result/best.log
'''
