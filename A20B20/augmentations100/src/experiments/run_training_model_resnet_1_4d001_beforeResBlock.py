...
import libs
import libs_dataset
import models.model_resnet_1_4d001_beforeResBlock.src.model as Modelresnet_1_4d001_beforeResBlock
...
train = libs.Train(dataset, Modelresnet_1_4d001_beforeResBlock, batch_size = 256, learning_rates = learning_rates)
train.step_epochs(epoch_count, log_path = "../models/model_resnet_1_4d001_beforeResBlock")
...
best model is saved into ../models/model_resnet_1_4d001_beforeResBlock/trained
and results into ../models/model_resnet_1_4d001_beforeResBlock/result/best.log
'''
