...
import libs
import libs_dataset
import models.model_resnet_2_4d05.src.model as Modelresnet_2_4d05
...
train = libs.Train(dataset, Modelresnet_2_4d05, batch_size = 256, learning_rates = learning_rates)
train.step_epochs(epoch_count, log_path = "../models/model_resnet_2_4d05")

'''
training result saved into ../models/model_resnet_2_4d05/result
...
best model is saved into ../models/model_resnet_2_4d05/trained
and results into ../models/model_resnet_2_4d05/result/best.log
'''
