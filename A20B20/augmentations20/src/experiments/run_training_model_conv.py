...
import libs
import libs_dataset
import models.model_conv.src.model as Modelconv
...
train = libs.Train(dataset, Modelconv, batch_size = 256, learning_rates = learning_rates)
train.step_epochs(epoch_count, log_path = "../models/model_conv")

'''
training result saved into ../models/model_conv/result
...
best model is saved into ../models/model_conv/trained
and results into ../models/model_conv/result/best.log
'''
