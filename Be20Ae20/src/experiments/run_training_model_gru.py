...
import libs
import libs_dataset
import models.model_gru.src.model as Modelgru
...
train = libs.Train(dataset, Modelgru, batch_size = 256, learning_rates = learning_rates)
...
and results into ../models/model_gru/result/best.log
'''
