...
import libs
import libs_dataset
import models.model_resnet_1.src.model as Modelresnet_1
...
train = libs.Train(dataset, Modelresnet_1, batch_size = 256, learning_rates = learning_rates)
train.step_epochs(epoch_count, log_path = "../models/model_resnet_1")

'''
training result saved into ../models/model_resnet_1/result
...
best model is saved into ../models/model_resnet_1/trained
and results into ../models/model_resnet_1/result/best.log
'''
